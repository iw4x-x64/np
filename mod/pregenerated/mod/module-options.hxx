  ...
  namespace options
  {
    class database
    {
      ...
      database (int& argc,
                char** argv,
                bool erase = false,
                ::np::cli::unknown_mode option = ::np::cli::unknown_mode::fail,
                ::np::cli::unknown_mode argument = ::np::cli::unknown_mode::stop);
      ...
      //
      static ::np::cli::usage_para
      print_usage (::std::ostream&,
                   ::np::cli::usage_para = ::np::cli::usage_para::none);

      // Option description.
      //
      static const ::np::cli::options&
      description ();
      ...
      bool
      _parse (const char*, ::np::cli::scanner&);

      private:
      bool
      _parse (::np::cli::scanner&,
              ::np::cli::unknown_mode option,
              ::np::cli::unknown_mode argument);
