  ...
  namespace options
  {
    class database
    {
      ...
      database (int& argc,
                char** argv,
                bool erase = false,
                ::np::mod::cli::unknown_mode option = ::np::mod::cli::unknown_mode::fail,
                ::np::mod::cli::unknown_mode argument = ::np::mod::cli::unknown_mode::stop);
      ...
      void
      np_db_user (const std::string&);

      bool
      np_db_user_specified () const;

      void
      np_db_user_specified (bool);

      // Print usage information.
      //
      static ::np::mod::cli::usage_para
      print_usage (::std::ostream&,
                   ::np::mod::cli::usage_para = ::np::mod::cli::usage_para::none);

      // Option description.
      //
      static const ::np::mod::cli::options&
      description ();

      // Implementation details.
      //
      protected:
      friend struct _cli_database_desc_type;

      static void
      fill (::np::mod::cli::options&);

      bool
      _parse (const char*, ::np::mod::cli::scanner&);

      private:
      bool
      _parse (::np::mod::cli::scanner&,
              ::np::mod::cli::unknown_mode option,
              ::np::mod::cli::unknown_mode argument);

      public:
      std::string np_db_user_;
      bool np_db_user_specified_;
    };
  }
}
